...
public class MatchController implements BaseController {
    ...
    @FXML private JFXButton coastPermitButton;
    @FXML private JFXButton hillPermitButton;
    @FXML private JFXButton mountainPermitButton;
    @FXML private Pane background;
    @FXML private Label nobilityPathText;
    @FXML private Label richPathText;
    @FXML private Label helperText;
    @FXML private Label victoryPathText;
    @FXML private Label fastActionText;
    @FXML private Label mainActionText;
