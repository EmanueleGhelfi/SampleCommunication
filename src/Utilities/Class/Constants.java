...
public class Constants {
    ...
    public static final String CODE_SELECT_CITY_REWARD_BONUS = "CODE_SELECT_CITY_REWARD_BONUS";
    public static final String CODE_CITY_REWARD_BONUS = "CODE_CITY_REWARD_BONUS";
    public static final String CODE_SELECT_PERMITCARD_BONUS = "CODE_SELECT_PERMITCARD_BONUS";
    public static final String CODE_SELECT_PERMIT_CARD = "CODE_SELECT_PERMIT_CARD";
    public static final String CODE_MOVE_KING = "CODE_MOVE_KING";
    ...
    public static final String STYLE_BUTTON = "button-raised";
